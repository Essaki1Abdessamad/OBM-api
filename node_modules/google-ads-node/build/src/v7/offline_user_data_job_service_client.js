...
class OfflineUserDataJobServiceClient {
    ...
    constructor(opts) {
        ...
        const runOfflineUserDataJobMetadata = protoFilesRoot.lookup('.google.protobuf.Empty');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v7.services.OfflineUserDataJobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.offlineUserDataJobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v7.services.OfflineUserDataJobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v7.services.OfflineUserDataJobService, this._opts);
