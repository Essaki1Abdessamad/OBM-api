...
export declare class GoogleAdsServiceClient {
    ...
    mutate(request: protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest, options?: CallOptions): Promise<[
        protos.google.ads.googleads.v7.services.IMutateGoogleAdsResponse,
        protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest | undefined,
        {} | undefined
    ]>;
    mutate(request: protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest, options: CallOptions, callback: Callback<protos.google.ads.googleads.v7.services.IMutateGoogleAdsResponse, protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest | null | undefined, {} | null | undefined>): void;
    mutate(request: protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest, callback: Callback<protos.google.ads.googleads.v7.services.IMutateGoogleAdsResponse, protos.google.ads.googleads.v7.services.IMutateGoogleAdsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * stream.on('end', () => { ... });
     */
    searchStream(request?: protos.google.ads.googleads.v7.services.ISearchGoogleAdsStreamRequest, options?: CallOptions): gax.CancellableStream;
    search(request: protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, options?: CallOptions): Promise<[
    ...
    search(request: protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, options: CallOptions, callback: PaginationCallback<protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, protos.google.ads.googleads.v7.services.ISearchGoogleAdsResponse | null | undefined, protos.google.ads.googleads.v7.services.IGoogleAdsRow>): void;
    search(request: protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, callback: PaginationCallback<protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, protos.google.ads.googleads.v7.services.ISearchGoogleAdsResponse | null | undefined, protos.google.ads.googleads.v7.services.IGoogleAdsRow>): void;
    /**
     ...
     *   for more details and examples.
     */
    searchStream1(request?: protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, options?: CallOptions): Transform;
    /**
     ...
     * }
     */
    searchAsync(request?: protos.google.ads.googleads.v7.services.ISearchGoogleAdsRequest, options?: CallOptions): AsyncIterable<protos.google.ads.googleads.v7.services.IGoogleAdsRow>;
    /**
